...
def main():
  ...
  print("\n\n")
  print("Negative articles: ", neg_vocab_proc.token_counter.most_common(50))

  cosine = get_cosine(pos_vocab_proc.token_counter, neg_vocab_proc.token_counter)
  print('Cosine:', cosine)
  # print("test: ", type(pos_vocab_proc.token_counter.keys()))
  # print(len(pos_vocab_proc.token_counter))
  # print(len(neg_vocab_proc.token_counter))
  intersection = set(pos_vocab_proc.token_counter.keys()) & set(neg_vocab_proc.token_counter.keys())
  # print(len(unique_words))
  pos_ranking = []
  pos_not_in_neg = 0
  neg_ranking = []
  for rank, pair in enumerate(pos_vocab_proc.token_counter.most_common()):
    if pair[0] in intersection:
      pos_ranking.append(rank + 1)
    else:
      pos_not_in_neg += 1
  print("pos: ", pos_ranking)
    
  neg_ranking = [rank for rank, pair in enumerate(neg_vocab_proc.token_counter.most_common())]  
